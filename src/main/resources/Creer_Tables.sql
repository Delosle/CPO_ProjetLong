...
(6, 'Organiser une journée de nettoyage des locaux pour rendre le campus plus propre et agréable. Les étudiants, le personnel et les enseignants sont invités à participer ensemble à cette initiative. En plus d améliorer l environnement de vie et d étude, cet événement renforce la communauté et la fierté collective. Un campus propre contribue au bien-être général et au bonheur de tous.', 10, -10, 10, 'Nettoyage des Locaux', 30, '2024-06-01', -10, 5, -5),
