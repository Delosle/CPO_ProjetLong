...
VALUES 
(1, 'Les enseignants sont en grève pour protester contre l absentéisme rampant et la pénurie chronique de tampons pour effacer les tableaux à craie. Fatigués de jongler entre classes désertes et tableaux illisibles, ils réclament des soutions pour redonner vie à leurs salles de classe!.', -10, 0, -10, 'Grèves des Enseignants', 1, FALSE),
(2, 'Nous regrettons de vous informer que notre livraison de chocolatines est retardée pour une raison aussi insolite qu inattendue : notre camion a été attaqué par une bande de singes farceurs en chemin vers Chocolatville ! L annulation de la livraison des chocolatines au foyer de l école a plongé les étudiants dans une tristesse collective. Privés de leur douce pause gourmande, l humeur générale a chuté, transformant les sourires en soupirs. Les chocolatines étant la clé du bonheur matinal, l impact se fait ressentir dans tout l établissement.', -10, 50, 0, 'Annulation Livraison Chocolatine', 1, FALSE),
...
(4, 'Chers membres de la communauté, Nous vous informons avec une pointe d humour mais aussi de sérieux qu une invasion de canards a été repérée à la Rivière des MFEE ! Ces adorables mais envahissants palmipèdes semblent être à la recherche d un point d eau paisible où se rafraîchir, et notre rivière semble être leur nouvelle destination favorite.', 15, 0, -5, 'ALERTE : Invasion de Canards à la Rivière des MFEE !d', 1, TRUE),
(5, 'Manque de chance : vous avez engagé un professeur incompétent. Il arrive 30 minutes après le début du cours et ne donne qu un seul exercice à faire pendant toute l heure. Une fois que les étudiants l ont terminé, il se cache derrière son ordinateur.', 0, 0, -10, 'Mauvais Professeurs', 1, FALSE),
...
(10, 'Nous vous informons qu un incident malheureux s est produit récemment impliquant une chaise défectueuse, ayant entraîné une légère blessure pour l un de nos élèves. Nous tenons à présenter nos excuses les plus sincères pour cet incident et à assurer à tous notre engagement envers la sécurité et le bien-être de nos étudiants. En signe de notre regret pour cet incident et pour compenser l inconfort causé, nous nous engageons à remplacer la chaise défectueuse par une nouvelle et sûre. De plus, nous offrirons à l élève concerné un Mars en guise de geste d excuse pour cet incident regrettable.', -10, 0, 0, 'Dysfonctions Équipements', 1, FALSE);
