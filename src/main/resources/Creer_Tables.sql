...
(5, 'Organisee une journée de nettoyage des locaux pour rendre le campus plus propre et agréable. Les étudiants, le personnel et les enseignants sont invités à participer ensemble à cette initiative. En plus d améliorer l environnement de vie et d étude, cet événement renforce la communauté et la fierté collective. Un campus propre contribue au bien-être général et au bonheur de tous.', 10, -10, 10, 'Nettoyage des Locaux', 30, '2024-06-01', -10, 5, -5),
(6, 'La campagne des listes arrive, tradition importante des écoles d ingénieurs, afin d aider à réaliser leur campagne, les étudiants viennent vous demander un financement. Ces campagnes incluent des activités et des événements visant à promouvoir les listes candidates pour les bureaux des étudiants. Participer à ces campagnes peut renforcer la cohésion des éléves entre eux, améliorer le bonheur des élèves et dynamiser la vie étudiante sur le campus. A contrario, les étudiants seront déçus en cas de non participation de votre part.', 10, -100, 0, 'Campagnes des Listes', 365, '2025-05-20', -10, 0, 0),
(7, 'Choisir si je fais un repas de Noël pour modifier le bonheur des élèves et du personnel.', 20, -5, -10, 'Repas de Noël', 365, '2024-12-01', -15, 0, 10),
